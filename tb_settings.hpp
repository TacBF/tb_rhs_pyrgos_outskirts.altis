class ICE
{
  ...
  class zones
  {
	...
	class gameModes
	{
	    class objectives
        {
            class zones
            {
                class captureRates
                {
                    ...
                    heldZoneMultiplier = 0.35; // Decimal value between 0 and N. (> 0, < 1 will reduce capture rate), (> 1 will increase capture rate). Eg: 0.25, 0.5, 0.75, 1.0, 1.25, 1.5
		...
		class AAD
		{
			attackerTicketsPerZoneCapture = 60;
        ...
        #define __unlimited -99
            kits[] =
            {
                // BLUFOR or ALL factions
                {
                    ...
                    {__ICE_gear_Grenadier, "Grenadier", 10, 1, 0, 4, 1},
                    {__ICE_gear_MG, "MG", 8, 1, 0, 3, 1},
                    {__ICE_gear_Medic, "Medic", 6, 2, 0, 4, 1},
                    {__ICE_gear_CombatEngineer, "Combat Engineer", 10, 1, 0, 3},
                    {__ICE_gear_LightAT, "Light AT", 5, 2, 0, 3, 2},
                    {__ICE_gear_HeavyAT, "Heavy AT", 5, 0, 0, 3, 1},
                    {__ICE_gear_AA, "Anti-Air", 10, 0, 0, 3, 1},
                    {__ICE_gear_Marksman, "Marksman", 18, 0, 0, 4, 1},
                    {__ICE_gear_Sniper, "Sniper", 18, 0, 0, 2, 1},
                    ...
                    {__ICE_gear_Diver, "Heavy MG", 14, 0, 0, 3, 1}
                },
				// OPFOR (delete OPFOR array or leave OPFOR array empty, to re-use (copy) BLUFOR array for both sides)
                {
                    ...
                    {__ICE_gear_Medic, "Medic", 6, 2, 0, 4, 1},
                    {__ICE_gear_CombatEngineer, "Combat Engineer", 10, 1, 0, 3},
                    {__ICE_gear_LightAT, "Light AT", 8, 2, 0, 3, 1},
                    {__ICE_gear_HeavyAT, "Heavy AT", 14, 0, 0, 2, 1},
